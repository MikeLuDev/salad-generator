...
const Header: React.FC = () => {
  ...
  const handleClick = (event: React.MouseEvent<HTMLElement>) => setAnchorEl(event.currentTarget as Element);
  ...
  return (
    <AppBar color="primary" position="static">
      <Toolbar>
        ...
        <Menu id="main-menu" anchorEl={anchorEl} keepMounted open={!!anchorEl} onClose={handleClose}>
